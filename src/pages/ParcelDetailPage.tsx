          ...
          {editing && (
            <div className="space-y-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-xs text-yellow-800">
                ✏️ You are editing this sample. All changes will be logged for audit purposes.
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input value={editForm.project_name} onChange={(e) => setEditForm(f => ({ ...f, project_name: e.target.value }))} placeholder="Project name" className="mt-1" />
                </div>

                <div>
                  <Label>Site location</Label>
                  <Input value={editForm.site_location} onChange={(e) => setEditForm(f => ({ ...f, site_location: e.target.value }))} placeholder="Site location" className="mt-1" />
                </div>
